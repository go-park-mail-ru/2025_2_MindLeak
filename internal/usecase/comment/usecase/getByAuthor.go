...
func (u *Usecase) GetCommentsByAuthor(ctx context.Context, authorId uuid.UUID) ([]dto.CommentDto, error) {
	comments, err := u.commentRepo.GetCommentsByAuthor(ctx, authorId)
	if err != nil {
