...
type Usecase interface {
	...
	CreateArticle(ctx context.Context, sessionID uuid.UUID, title, content string, topicID uuid.UUID, file *multipart.FileHeader) (models.Article, error)
	DeleteArticle(ctx context.Context, sessionID, articleID uuid.UUID) (bool, error)
	UpdateArticle(ctx context.Context, sessionID uuid.UUID, articleID uuid.UUID, title, content, status *string, topicID *uuid.UUID, file *multipart.FileHeader) (models.Article, error)
